 ...
 */
s32
ioreservewin(u32 port, u32 win, u32 size, u32 align, char *tag)
{
	IOMap *m, **l;
 ...
 */
u32
ioreserve(u32 port, u32 size, u32 align, char *tag)
{
	if(port == -1)
...
static s32
iomapread(Chan*, void *a, s32 n, s64 offset)
{
	char buf[32];
	IOMap *m;
	int i;
